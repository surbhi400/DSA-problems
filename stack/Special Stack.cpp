...
int getMin(stack<int>& s){
	// Your code goes here
	//At first we popping the top element from the stack and storing it in an integer.
	// Then we are popping other elements one by one and checking that is that element smaller than the current stored element. if yes then store it in integer otherwise move to the next element;
